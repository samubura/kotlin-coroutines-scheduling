...
class IntentionDispatcher(wrappedInterceptor: ContinuationInterceptor)
    : it.unibo.jakta.intention.DelayPropagatingContinuationInterceptorWrapper(wrappedInterceptor) {
    ...
    override fun dispatch(context: CoroutineContext, block: Runnable) {
        log.d { "Intercepting continuation with context: $context" }
            val currentIntention: it.unibo.jakta.intention.Intention = context[_root_ide_package_.it.unibo.jakta.intention.Intention.Key] as it.unibo.jakta.intention.Intention

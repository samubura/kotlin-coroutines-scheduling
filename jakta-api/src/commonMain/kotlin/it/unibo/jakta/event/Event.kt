...
sealed interface Event {
    sealed interface Internal : it.unibo.jakta.event.Event {
        val intention: it.unibo.jakta.intention.Intention? // TODO needed?
        ...
        data class Step(override val intention: it.unibo.jakta.intention.Intention) : Internal
    }
